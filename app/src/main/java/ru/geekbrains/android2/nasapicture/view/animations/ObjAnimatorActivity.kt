...
class ObjAnimatorActivity : AppCompatActivity() {
            ...
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    option_two_container.setOnClickListener {
                        Toast.makeText(this@ObjAnimatorActivity, "Option 2", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
            })
            ...
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    option_one_container.setOnClickListener {
                        Toast.makeText(this@ObjAnimatorActivity, "Option 1", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
            })
